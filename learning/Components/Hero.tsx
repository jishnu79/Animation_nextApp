        ...
        <div className='pb-20 pt-36'>
          ...
          [mask-image:radial-gradient(ellipse_at_center,transparent_20%,black)]"
            ...
            <div className='flex justify-center relative my-20 z-10'>
                <div className=' max-w-[89vm] md:max-w-2xl lg:max-w-[60vm] flex flex-col 
                items-center '>
                    ...
                    />
                    <p className='text-center text-white md:tracking-wider mb-4 text-sm md:text-lg
                    lg:text-2xl'>
                        Hi , I&apos;m jishnu, a next.js Developer based in kerala
                    </p>
                    <a href="#about">
                        <MagicButton
                            title='show my work'
